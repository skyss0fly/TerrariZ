...
use TerrariZ\TerrariaProtocol\EssentialTilesPacket;
use TerrariZ\TerrariaProtocol\WorldInfoPacket;
use TerrariZ\TerrariaProtocol\PlayerHPPacket;
use TerrariZ\TerrariaProtocol\PlayerManaPacket;
use TerrariZ\TerrariaProtocol\ManaEffectPacket;
use TerrariZ\TerrariaProtocol\PlayerBuffPacket;
use TerrariZ\TerrariaProtocol\PlayerSpawnPacket;
use TerrariZ\TerrariaProtocol\LoadNetModulePacket;
...
class PacketHandler
{
    ...
    6 => WorldInfoPacket::class,
    8 => EssentialTilesPacket::class,
    12 => PlayerSpawnPacket::class,
    16 => PlayerHPPacket::class,
    38 => PasswordVerificationPacket::class,
    42 => PlayerManaPacket::class,
    43 => ManaEffectPacket::class,
    50 => PlayerBuffPacket::class,
    68 => SyncUUIDPacket::class,
    82 => LoadNetModulePacket::class,
];
