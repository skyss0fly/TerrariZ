...
private bool $worldReceived = false;
...
public function setPosition(int $tileX, int $tileY): void
{
    $this->tileX = $tileX;
    $this->tileY = $tileY;
}
...
public function hasReceivedWorld(): bool
{
    return $this->worldReceived;
}

public function setReceivedWorld(bool $v): void
{
    $this->worldReceived = $v;
}
}
